# test_embedder.py
import pytest
from src.implementations.embedding.embedder import Embedder, EmbedderError
...
def test_embedder_initialization():
    embedder = Embedder(model_name=TEST_MODEL, batch_size=2)
...
def test_invalid_model_name():
    with pytest.raises(Embedder):
        Embedder(model_name="non_existent_model_12345")
